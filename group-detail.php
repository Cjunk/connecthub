...
$groupPrivacy = $group['privacy_level'] ?? $group['privacy'] ?? 'public';
  ...
  <div class="row">
    ...
    <div class="card shadow-sm border-0 mb-4">
        ...
        <div class="d-flex flex-wrap align-items-center mb-3">
            ...
            <?php endif; ?>
            <?php if ($groupPrivacy !== 'public'): ?>
            <span class="badge bg-warning text-dark">
              <i class="fas fa-lock me-1"></i><?= ucfirst($groupPrivacy) ?>
            </span>
            <?php endif; ?>
        </div>
