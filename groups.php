...
$groups = !empty($filters['mine'])
    ? $groupModel->getUserGroups($currentUser['id'])
    : $groupModel->getAll($filters);
...
<div class="container">
    <?php
    $title = !empty($filters['mine']) ? "My Groups" : "Browse Groups";
    $subtitle = !empty($filters['mine']) ? "Groups you have already joined" : "Connect with like-minded people in your community";
    $icon = "fas fa-users";
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <?php if (!empty($filters) && empty($filters['mine'])): ?>
                    <div class="mt-3">
        ...
        <?php if (empty($groups)): ?>
            <div class="col-12">
                <div class="text-center py-5">
                    ...
                    <h4 class="text-muted"><?php echo !empty($filters['mine']) ? 'No groups joined yet' : 'No groups found'; ?></h4>
                    <?php if (!empty($filters['mine'])): ?>
                        <p class="text-muted">Join a group from the browse page to see it here.</p>
