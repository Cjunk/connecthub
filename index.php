                ...
                <div class="d-flex gap-3 flex-wrap">
                    <?php if (!isLoggedIn()): ?>
                        <a href="<?php echo BASE_URL; ?>/register.php" class="btn btn-light btn-lg">
                            <i class="fas fa-user-plus me-2"></i>Join Uhura
                        </a>
...
<section class="py-5">
    <div class="container">
        <div class="text-center mb-5">
            <h2 class="display-5 fw-bold">Why Choose Uhura?</h2>
